...
- RU facts: Любой раунд, конец вашего хода: 3VP, если в этот ход уничтожено хотя бы одно вражеское подразделение. Со 2-го раунда, конец вашей фазы командования (в 5-м - конец вашего хода): 4VP за каждую контролируемую цель, кроме домашней. Со 2-го раунда, конец вашего хода: 3VP, если вы контролируете хотя бы одну не домашнюю цель, которую вы не контролировали в начале хода. Конец боя: 5VP за контроль хотя бы одной центральной цели.
...
- RU facts: Когда дружественное подразделение уничтожает подразделение, оно становится подразделением **освящения**. В конце вашего хода каждое такое подразделение может выбрать одну ещё не освящённую цель в своей зоне досягаемости, кроме домашней; поместите один из ваших маркеров операции в пределах цели, цель становится **освящённой**, а подразделение теряет статус освящения. Любой раунд, конец вашего хода: выберите только одно - 3VP за 1-2 освящённые цели либо 6VP за 3 и более. Со 2-го раунда, конец вашей фазы командования (в 5-м - конец вашего хода): 4VP за контроль хотя бы одной не домашней цели; 4VP, если вы контролируете больше целей, чем противник. Конец боя: 5VP, если домашняя цель противника освящена.
...
- RU facts: Любой раунд, конец вашего хода: 2VP за каждую **ложную** цель; ещё 2VP за каждую из них на территории противника (накопительно). Со 2-го раунда, конец вашей фазы командования (в 5-м - конец вашего хода): 4VP за контроль хотя бы одной не домашней цели. Конец боя: 10VP, если ложными стали 4 и более целей. Обратная сторона - **Decoy**: начало в вашей фазе стрельбы; одно дружественное подразделение в пределах ещё не ложной не домашней цели; без лимита, но каждое подразделение выбирает другую цель; завершение в конце вашего хода, если подразделение контролирует цель; цель становится **ложной**, поместите рядом один из ваших маркеров операции. Удаление маркера снимает статус.
